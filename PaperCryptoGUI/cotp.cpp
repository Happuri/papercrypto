...
string cOTP::enc_menu(string mess, bool a)
{
    //string mess, //dec;//mess - message to cipher, dec - decision to make, mess_u - for normal looking message generator
    string less; //pad - secret code for operation, less - if too less characters in handmade pad, coded - coded message
...
string cOTP::get_enc_mess(string mess) //get message for encryption
{
